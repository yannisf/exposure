...
public class Shutter extends ExposureParameter {
    ...
    static {
        ...
        VALUES.add(new ExposureValue("1/60", new BigDecimal("0.01666667"), TYPE, Granularity.FULL));
        ...
        VALUES.add(new ExposureValue("1/30", new BigDecimal("0.03333333"), TYPE, Granularity.FULL));
        ...
        VALUES.add(new ExposureValue("1/15", new BigDecimal("0.06666667"), TYPE, Granularity.FULL));
        VALUES.add(new ExposureValue("1/13", new BigDecimal("0.07692308"), TYPE, Granularity.THIRD));
        ...
        VALUES.add(new ExposureValue("1/6", new BigDecimal("0.16666667"), TYPE, Granularity.THIRD));
        ...
        VALUES.add(new ExposureValue("1/3", new BigDecimal("0.33333333"), TYPE, Granularity.THIRD));
        ...
        VALUES.add(new ExposureValue("1/1.3", new BigDecimal("0.76923077"), TYPE, Granularity.THIRD));
