...
public class ShootingConditions {
    ...
    public ShootingConditions(String setIso, String setAperture, String setShutterSpeed) {
        isoSensitivity = new Iso(setIso);
        aperture = new Aperture(setAperture);
        shutterSpeed = new Shutter(setShutterSpeed);
    }

    public ShootingConditions(String setIso, String setAperture, String setShutterSpeed, Priority priority) {
    ...
    public void updateAperture(String setUpdatedAperture) {
        ...
        shutterSpeed = (Shutter) shutterSpeed.displaceBy(indexDifference);
    ...
    public void updateShutterSpeed(String setUpdatedShutterSpeed) {
        ...
        aperture = (Aperture) aperture.displaceBy(indexDifference);
        System.out.println("AFTER: " + this);
    }
